...
class RegionDropDownList extends PureComponent {
    constructor(props) {
        super(props);
    ...
    async componentDidMount() {
        await this.props.RegionController.GetListRegion(this.props.accId)
    }

    componentWillReceiveProps(nextProps) {
        if (nextProps.accId !== this.props.accId) {
            this.props.RegionController.GetListRegion(nextProps.accId)
        }
    }


    render() {
        const regions = this.props.regions ? this.props.regions : [];
        let result = [], lstItem = [];
...
export default connect(mapStateToProps, mapDispatchToProps)(RegionDropDownList);
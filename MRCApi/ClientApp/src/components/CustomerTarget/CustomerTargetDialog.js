...
class CustomerTargetDialog extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <div className="p-fluid p-formgrid p-grid">
          <div className="p-field p-col-12 p-md-3 p-sm-6">
            ...
            <Calendar
              ...
              onChange={(e) =>
                handleChangeForm(e.target.value, stateName, "dates")
              }
              dateFormat="yy-mm-dd"
          ...
          <div className="p-field p-col-12 p-md-3 p-sm-6">
            ...
            <span className="p-float-label">
              <InputNumber
                ...
                onChange={(e) =>
                  handleChangeForm(e.value, stateName, "percent")
                }
              />
            </span>
            <small style={{ color: "red" }} className="p-invalid p-d-block">
              {inputValues.errorPercent || ""}
            </small>
          </div>
          <div className="p-field p-col-12 p-md-3 p-sm-6">
            ...
            <span className="p-float-label">
              <InputNumber
                ...
                onChange={(e) => handleChangeForm(e.value, stateName, "target")}
              />
            </span>
            <small style={{ color: "red" }} className="p-invalid p-d-block">
              {inputValues.errorTarget || ""}
            </small>
          </div>
        </div>
      </Dialog>

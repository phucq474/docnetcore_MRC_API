...
{
    public interface IShopByCustomerService
    {
    ...
    public class ShopByCustomerService : IShopByCustomerService
    {
        private readonly ShopByCustomerContext _context;
        public ShopByCustomerService(ShopByCustomerContext context)
        {
            _context = context;
        }
